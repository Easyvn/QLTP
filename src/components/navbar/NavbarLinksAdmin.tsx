...
export default function HeaderLinks(props: { secondary: boolean }) {
	...
	return (
		<Flex
			...
			<SidebarResponsive routes={displayRouters} />
			<Menu>
				<MenuButton p='0px'>
				...
				<MenuList boxShadow={shadow} p='0px' mt='10px' borderRadius='20px' bg={menuBg} border='none'>
					...
					<Flex flexDirection='column' p='10px'>
						<MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius='8px' px='14px'>
							<Text fontSize='sm' onClick={toChangePassword}>Tài khoản</Text>
						</MenuItem>
						{/* <MenuItem _hover={{ bg: 'none' }} _focus={{ bg: 'none' }} borderRadius='8px' px='14px'>
						...
						<MenuItem
							...
							borderRadius='8px'
							px='14px'>
							<Text fontSize='sm' onClick={()=>logout()}>Đăng xuất</Text>
						</MenuItem>
					</Flex>
				</MenuList>
			</Menu>

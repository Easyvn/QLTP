...
function UpdateCaseModal(props: { isOpen: boolean, _case: Case, onDeleteCase: (_case: Case) => void, onOpen: () => void, onClose: () => void }) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      ...
      <ModalContent>
        ...
        <ModalFooter>
          <Button colorScheme="red" mr={3} spinner={<BeatLoader size={8} color="white" />}>
            Xoá
          </Button>

import { Evidence, EvidenceReport, EvidenceResultType, EvidenceType } from "core/domain/models/evidences.model";
...
export class EvidenceDto {
    ...
    static fromEvidence(evidence: EvidenceReport, eviTypes: EvidenceType[], results: EvidenceResultType[]): EvidenceDto {
